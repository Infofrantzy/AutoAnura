...
class script(object):
    ...
    START_TXT = environ.get("START_TXT", "𝙷𝙴𝙻𝙾 {}. 👋 MON NOM EST {bot}.

Je suis un bot de recherche de films/séries, je peux partager des films et des séries avec toi</b>

Ajoute moi dans ton groupe et regarde la magie s'opèrer ou suis simplement les instructions dans le menu</b>")
    HELP_TXT = """𝙷𝙴𝚈 {}
𝙷𝙴𝚁𝙴 𝙸𝚂 𝙼𝚈 𝙷𝙴𝙻𝙿 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}</b>
<b>✮ 𝙲𝚁𝙴𝙰𝚃𝙾𝚁: <a href=https://t.me/zosman_official>ZOMAN</a></b>
<b>✮ 𝙻𝙸𝙱𝚁𝙰𝚁𝚈: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼</b>
<b>✮ 𝙻𝙰𝙽𝙶𝚄𝙰𝙶𝙴: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹</b>
<b>✮ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾-𝙳𝙱</b>
<b>✮ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄</b>
<b>✮ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: 𝚅1.0.43 [ 𝙱𝙴𝚃𝙰 ]</b>
<b>✮ 𝚈𝙾𝚄𝚃𝚄𝙱𝙴 𝙲𝙷𝙰𝙽𝙽𝙴𝙻: <a href=https://www.youtube.com/@ZMO-Tech>ZMO-Tech</a></b>"""
    SOURCE_TXT = """<b>NOTE:</b>
- ᎯℕUℛᎯᎶ is a not open source project. 
- Source - https://t.me/zosman_official

<b>DEVS:</b>
- <a href=https://t.me/zosman_official>ZOSMAN</a>"""
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/zosman_official)</code>
